...
#define TWI_IRQ_PRIORITY_NO_SD  0   // 3, 2, 1 or 0 - lower values -> higher priority

// Set these defines to decide which TWI interface to use, either TWI0 or TWI1 in the nRF51822
#define TWI                     NRF_TWI0
#define TWI_INTERRUPT           SPI0_TWI0_IRQHandler
#define TWI_INTERRUPT_NO        SPI0_TWI0_IRQn
