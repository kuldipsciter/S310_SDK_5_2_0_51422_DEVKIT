...
/* 			DEVKIT 												*/
/****************************************************************/
/* UID_CHARACTERISTICS Characteristic UUID definitions for Motor operation applicatipn (belwith) */

/* Motor operation Service */
#define BLE_UUID_BLUETOOTH_SIG_BASE {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}

#define BLE_UUID_TYPE_MOTOR_OPEARATION 																BLE_UUID_TYPE_VENDOR_BEGIN+1
#define BLE_UUID_DEV_KIT_BASE 		{0xF5, 0x1E, 0xC0, 0x5A, 0x0D, 0x08, 0x91, 0xB3, 0x91, 0x4E, 0x81, 0x72, 0x3F, 0x40, 0x2F, 0xC0}
				 //C02F403F-7281-4E91-B391-080D5AC01EF5
#define BLE_UUID_DEV_KIT_SERVICE															0x6469	

//#define BLE_UUID_DEV_KIT_OP_REQ																0x4040			/* request forward or reverse motor operation */
//#define BLE_UUID_DEV_KIT_OP_STATUS														0x403F			/* current Switch - notification */




#define BLE_UUID_DEV_KIT_OP_REQ											0x2C01			/* Write Command */
#define BLE_UUID_READ_SL_DATA												0x2C02			/* Read Data */
#define BLE_UUID_OPERATION_STATUS										0x2C03			/* current Operations - notification */
//#define BLE_UUID_LOCK_STATUS												0x2C04			/* current state of lock - open or close - notification */
#define BLE_UUID_DEV_KIT_OP_STATUS									0x2C05			/* Devkit - notification */
#define BLE_UUID_DEV_KIT_UART_MSG										0x2C06			/* Define for get UART msg received from central*/
...
/* UID_CHARACTERISTICS Characteristic UUID definitions for Smart Lock applicatipn (belwith) */
...
void ble_srv_ascii_to_utf8_len(ble_srv_utf8_str_t * p_utf8, char * p_ascii, uint8_t len);
